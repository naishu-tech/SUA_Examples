...
int main() {
    std::cout << "=== AWG wfm QI Play Test ===" << std::endl;
    ...
    std::cout << "\n=== DUC Config ===" << std::endl;
    s = DUCConfigAWG(iviFgen_vi, 1, "-1", 0);

    std::cout << "\n=== DUC Config ===" << std::endl;
    s = IviFgen_SetAttributeViUInt32(iviFgen_vi, "0", IVIFGEN_ATTR_DAC_INTERNAL_MULTIPLE, 2);
...
//)";
    ...
    std::list<ViString> wfmPath_list = {
            "./wfm/QIExtend_2000MSps_0Offset_1Amp_100MHz_0MBw_0Phase_1024us_16bit_Signed_1024us_1Row_1Column.dat"
    };
