...
int main() {
    ...
    std::list<ViString> wfmPath_list = {
            ...
            "./wfm/Sin_Fixed_4000MSps_0Offset_1Amp_200MHz_0MBw_0Phase_1024us_16bit_Signed_1024us_1Row_1Column.dat",
            "./wfm/Sin_Fixed_4000MSps_0Offset_1Amp_300MHz_0MBw_0Phase_1024us_16bit_Signed_1024us_1Row_1Column.dat",
            "./wfm/Sin_Fixed_4000MSps_0Offset_1Amp_400MHz_0MBw_0Phase_1024us_16bit_Signed_1024us_1Row_1Column.dat",
            "./wfm/Sin_Fixed_4000MSps_0Offset_1Amp_500MHz_0MBw_0Phase_1024us_16bit_Signed_1024us_1Row_1Column.dat",
            "./wfm/Sin_Fixed_4000MSps_0Offset_1Amp_600MHz_0MBw_0Phase_1024us_16bit_Signed_1024us_1Row_1Column.dat",
            "./wfm/Sin_Fixed_4000MSps_0Offset_1Amp_700MHz_0MBw_0Phase_1024us_16bit_Signed_1024us_1Row_1Column.dat",
            "./wfm/Sin_Fixed_4000MSps_0Offset_1Amp_800MHz_0MBw_0Phase_1024us_16bit_Signed_1024us_1Row_1Column.dat",
    };
    ...
    // 分别跟踪不同类型的内存分配
    std::vector<ViChar*> charBuffers;
    std::vector<ViInt16*> int16Buffers;
    ...
    for (auto& wfmPath : wfmPath_list) {
        ...
        int16Buffers.push_back(bufferWfm);
        ...
        ViString segName = "seg" + std::to_string(i);
        waveformHandle_map[segName] = wfmHandle;
        i += 1;
    }
    ...
    //4: 循环播放：Loop + 等待触发
    //其他: 顺序播放
    ViString nswave_code = create_nswave_code(waveformHandle_map, 3);
    ...
    // 释放内存时
    for (auto ptr : charBuffers) {
        delete[] ptr;
    }
    charBuffers.clear();

    for (auto ptr : int16Buffers) {
        delete[] ptr;
    }
    int16Buffers.clear();
    return 0;
