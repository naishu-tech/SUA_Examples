...
struct nsuGPUPeerParam_t{
    nsuRegAddr_t FPGA_board=0;
    nsuRegAddr_t GPU_board=0;
};

struct nsuFPGAPeerParam_t{
    nsuBoardNum_t FPGA_src_board=0;
    nsuBoardNum_t FPGA_dst_board=1;
};
...
struct NSU_DLLEXPORT nsuInitParam_t: nsuTCPParam_t, nsuSerialParam_t, nsuXDMAParam_t, nsuSimParam_t, nsuVpsParam_t, nsuGPUPeerParam_t, nsuFPGAPeerParam_t, nsuMwParam_t {};
#endif //NSUKIT_TYPE_H
